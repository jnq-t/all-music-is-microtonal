...
const mock_length = 12;
  ...
  export default function createKeyElement (key, index, container ) {
    ...
    keyContainer.appendChild(KeyModifiers.createSustainModifier(index, mock_octave))
    // adds detune and ratio modifier to first octave only //todo: replace mock_length with actual length
