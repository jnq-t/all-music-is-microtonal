...
//todo: refactor code
   ...
   */
  export default function createKeyElement (key, index, container, lengthOfScale) {
    ...
    keyModifiersContainer.appendChild( KeyModifiers.createSustainModifier(index, lengthOfScale)) // append sustain modifier
     if (index < lengthOfScale) { // appends detune and ratio modifier to first octave only 
      keyModifiersContainer.appendChild(KeyModifiers.createDetuneModifier(index, lengthOfScale))
      keyModifiersContainer.appendChild(KeyModifiers.createRatioModifier(index, lengthOfScale))
    }
